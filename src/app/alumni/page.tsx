...
const Alumni = () => {
  ...
  return (
    <div className="min-h-screen pt-20" data-testid="page-alumni">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-r from-primary-teal to-primary-blue text-white" data-testid="section-alumni-hero">
