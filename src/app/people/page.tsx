...
const People = () => {
  ...
  return (
    <div className="min-h-screen " data-testid="page-people">
      {/* Hero Section */}
      <section className=" bg-gradient-to-r from-primary-teal to-primary-blue text-white" data-testid="section-people-hero">
